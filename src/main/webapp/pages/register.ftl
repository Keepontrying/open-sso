    ...
    <script>
	    $(function(){
			...
			$(".login-btn").click(function(){
				...
				var obj = {};
				obj.loginPhoneNo = $("#loginPhoneNo").val().trim();
				obj.loginPassword = cryptico.encrypt($("#loginPassword").val().trim()).cipher;
	    		...
	    		$.ajax({
					...
					success:function(data){
						if(data.success){
							...
							if(data.msg == "phoneExist"){
								$("#pErrMsg").html("手机号码已注册");
								$("#pErrMsg").show();
							}
        ...
        <div class="cont-box clearfix">
            ...
            <div class="login-status">
                ...
                <div class="pc-boss">
                    ...
                    <a href="javascript:" class="login-btn">立即注册</a>
